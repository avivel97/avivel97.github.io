(function () {
  const russian = {
    ...
    "Choose a convenient time": "Выберите удобное время",
    "Select an available time in the calendar below. The booking is handled by Cal.com.": "Выберите доступное время в календаре ниже. Бронирование обрабатывается сервисом Cal.com.",
    "Cal.com booking calendar": "Календарь записи Cal.com",
    "JavaScript is required to display the calendar.": "Для отображения календаря требуется JavaScript.",
    "Open Cal.com": "Открыть Cal.com",
